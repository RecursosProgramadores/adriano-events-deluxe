...
const socialLinks = [
  { icon: Instagram, href: "https://www.instagram.com/eventosadriano.pe?igsh=MTF3aHV4YzAxZzN5cA%3D%3D&utm_source=qr", label: "Instagram" },
  { icon: Facebook, href: "https://www.facebook.com/AdrianosEventPlanner", label: "Facebook" },
  { icon: Youtube, href: "https://youtube.com/@adrianoeventospe?si=OrSiIxCdL6UwscKl", label: "YouTube" },
  { icon: TikTokIcon, href: "https://www.tiktok.com/@adrianoeventos?_r=1&_t=ZS-93hja9myFkq", label: "TikTok" },
];
